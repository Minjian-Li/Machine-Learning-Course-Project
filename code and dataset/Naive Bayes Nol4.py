...
# loading data
rawData1 = pd.read_csv('Data/nol4/x_test.csv')
rawData2 = pd.read_csv('Data/nol4/y_test.csv')
rawData3 = pd.read_csv('Data/nol4/x_validation.csv')
rawData4 = pd.read_csv('Data/nol4/y_validation.csv')
rawData5 = pd.read_csv('Data/nol4/x_train.csv')
rawData6 = pd.read_csv('Data/nol4/y_train.csv')
...
for j in range(np.shape(x_train)[1]):
    ...
    probability_TBL0[j] = [P_f0_c1, P_f0_c2, P_f0_c3]
    probability_TBL1[j] = [P_f1_c1, P_f1_c2, P_f1_c3]
